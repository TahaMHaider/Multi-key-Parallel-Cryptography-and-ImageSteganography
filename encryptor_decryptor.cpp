/********************************************************************
* 	Project Name: Information Security								*
*	Team Members: Faiq Nadeem [18k-1194]							*
*				  Ghulam Asghar Dahri ( 18K-0152 )					*  
*				  Muhammad Taha Haider ( 18K-0341 )					*
*********************************************************************/
#include<bits/stdc++.h> 
#include<conio.h> 
#include<ctype.h>
...
void MainScreen(){
	...
	string author="\n\t\t\xba\t\t* Faiq Nadeem [18k-1194]\t* Muhammad Taha Haider[18K-0341]\t*Ghulam Asghar Dahri [18K-0152]\t\t \xba\n";
